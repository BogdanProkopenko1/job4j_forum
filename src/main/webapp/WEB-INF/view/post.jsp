...
<div class="container mt-3">
    ...
    <div style="margin-top: 2%" class="container pt-3">
        <div class="card">
            <div class="card-header">
                <h6><c:out value="${post.name}"/> (<c:out value="${post.created}"/>)</h6>
                <a style="margin-left: 1%; font-size: 14px" href="<c:url value='/update?id=${post.id}'/>">Edit</a>
            </div>
            <div class="card-body">
    ...
    <div class="row">
        ...
        <button style="margin-top: 1%" type="submit" class="btn btn-primary">Send</button>
    </form>
</div>
